...
import java.io.File;
	...
	/** 
	 * all the required paths of the files are mentioned here.
	 * 
	 *
	 */
public class ConstantFilePaths 
{
	...
	public final static String resource_Home = homeDir + "src${symbol_escape}${symbol_escape}test${symbol_escape}${symbol_escape}resources" + File.separator ;
